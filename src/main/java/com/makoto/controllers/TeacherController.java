...
public class TeacherController implements CrudHandler {
    ...
    private final String apiTag = "TeacherAPI1";
    ...
    @OpenApi(summary = "delete a course", operationId = "deleteCourse", methods = HttpMethod.DELETE,
            tags = apiTag, path = prefixRoute + "/{courseCode}",
            pathParams = {@OpenApiParam(name = "courseCode", type = Integer.class, required = true,
    ...
    @OpenApi(summary = "Get all course", operationId = "getAllCourse", methods = HttpMethod.GET,
            tags = apiTag, path = prefixRoute, responses = {@OpenApiResponse(status = "200")})
    @Override
    ...
    @OpenApi(summary = "update one course", operationId = "updateCourse",
            methods = HttpMethod.PATCH, tags = apiTag, path = prefixRoute + "/{courseCode}",
            pathParams = {@OpenApiParam(name = "courseCode", type = Integer.class, required = true,
                    description = "The course code")},
            responses = {@OpenApiResponse(status = "204")})
    @Override
