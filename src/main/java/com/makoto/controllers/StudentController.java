...
public class StudentController {
    ...
    private final String apiTag = "StudentAPI1";
    ...
    @OpenApi(summary = "Register course", operationId = "registerCourse", methods = HttpMethod.POST,
            tags = apiTag, path = prefixRoute + "/course/register",
